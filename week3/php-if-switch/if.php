...
<html>
    ...
    <body>
        ...
        // If there is no title, use the link URL as a title
        if ($linkName == "")
        {
            echo '<h2>'.$linkURL.'</h2>';
        }
        // If there is a title, output the name
        else
        {
            echo '<h2>'.$linkName.'</h2>';
        }
        ...
        // If there is no image, output the attached image
        else
        {
            echo '<img src="w3schools.png" width="300px">';
        }
